...
public enum ModArmorMaterials implements ArmorMaterial {
    COBALT("cobalt", 43, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266649_) -> {
    ...
    }), 10, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0F, 0.05F, () -> Ingredient.of(ModItems.COBALT_INGOT.get()));
    ...
    public String getName() {
        return alloy_furnace.MOD_ID + ":" + this.name;
    }
