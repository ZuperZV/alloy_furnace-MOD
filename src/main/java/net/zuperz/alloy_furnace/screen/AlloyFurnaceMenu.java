...
import net.zuperz.alloy_furnace.block.entity.AlloyFurnaceBlockEntity;
...
public class AlloyFurnaceMenu extends AbstractContainerMenu {
    ...
    public AlloyFurnaceMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(iItemHandler -> {
            this.addSlot(new SlotItemHandler(iItemHandler, 0, 13, 16));
            this.addSlot(new SlotItemHandler(iItemHandler, 1, 35, 14));
            this.addSlot(new SlotItemHandler(iItemHandler, 2, 57, 16));
            this.addSlot(new SlotItemHandler(iItemHandler, 3, 134, 35));
            this.addSlot(new SlotItemHandler(iItemHandler, 4, 35, 56));
        });
